    ...
    if (e.controlId == 1) {
      ...
      for(var i=0;i<scheduleList.length;i++){
        if((scheduleList[i].dayOfWeek == day && scheduleList[i].timePeriod == (hour+1)) || (scheduleList[i].dayOfWeek == day && scheduleList[i].timePeriod == (hour+2))) {
          var locationName = scheduleList[i].address.split(0,2);
      ...
      if (market == true){
        wx.showModal({
          ...
          content: 'The next lesson — ' + scheduleInfo.className + ' will begin at ' + scheduleInfo.timePeriod + ' ：00 at ' + scheduleInfo.address ,
